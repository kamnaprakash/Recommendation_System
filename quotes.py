...
#
# st.header("Emotion Based Quotes Recommender")
#
...
#
# btn = st.button("Recommend me quotes")
#
# if btn:
#     if not (emotion):
...
#         st.session_state["run"] = "true"
#     else:
#         webbrowser.open( f"https://www.goodreads.com/quotes/search?utf8=%E2%9C%93&q={emotion}&commit=Search")
